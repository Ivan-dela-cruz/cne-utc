        ...
        <div class="dashboard-message">
            ...
            <div class="dashboard-listing-table-text">
                <div class="row">
                    ...
                    <div class="booking-details fl-wrap">
                        ...
                        <span class="booking-text"><a
                                href="listing-sinle.html">{{$province->name}}</a></span>
                    </div>
                    <div class="booking-details fl-wrap">
                ...
                <ul class="dashboard-listing-table-opt  fl-wrap">
                    <li><a href="{{route('candidates.edit',$province->id)}}">Editar <i class="fa fa-pencil-square-o"></i></a>
                    </li>
                    {!! Form::open(['route' => ['candidates.destroy', $province->id], 'method' => 'DELETE','class'=>'delete-item'.$province->id]) !!}
