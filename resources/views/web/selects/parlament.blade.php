                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="accordion">
                                                    ...
                                                    <div class="accordion-inner">
                                                        <ul>
                                                            @foreach($organization->candidates->where('indent',env('POSITION_PARLAMENT','PA')) as $candidate)
                                                            <li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="list-single-main-item fl-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <input hidden  name="type_election" value="{{env('POSTION_PARLAMENT','PA')}}" type="text">
