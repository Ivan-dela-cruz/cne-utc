                    ...
                    <div class="row" id ="ContentListCandidates">
                        <div class="col-md-12">
                            <div class="listsearch-header fl-wrap">
                                <h3>Asambleistas Provinciales</h3>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="accordion">
                                                    ...
                                                    <div class="accordion-inner">
                                                        <ul>
                                                            @foreach($organization->candidates->where('indent',env('POSITION_PROVINCE','AP')) as $candidate)
                                                            <li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="list-single-main-item fl-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <input hidden  name="type_election" value="{{env('POSITION_PROVINCE','AP')}}" type="text">
